...
try {
	...
	Assert-FileContains $releaseNotes "OFXGGML_DIFFUSION_VERSION_STRING.*1\.0\.1" "v1.0.1 release notes"
	Assert-FileContains $releaseNotes "does not claim complete Stable Diffusion" "v1.0.1 release notes"
